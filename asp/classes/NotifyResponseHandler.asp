...
Class NotifyResponseHandler
	...
	Public Function isTenpaySign()
		...
		cash_ticket_fee = getParameter("cash_ticket_fee")
		agentid = getParameter("agentid")
		signPars = Array("sign_type="&sign_type, "service_version="&service_version, "input_charset="&input_charset,"sign_key_index="&sign_key_index, "retcode=" & retcode,"trade_mode="&trade_mode, "trade_state="&trade_state, "retmsg="&retmsg,"partner="&partner, "bank_type="&bank_type, "bank_billno="&bank_billno, "total_fee="&total_fee, "fee_type="&fee_type , "transaction_id="&transaction_id, "out_trade_no="&out_trade_no,"attach="&attach, "time_end="&time_end, "transport_fee="&transport_fee, "product_fee="&product_fee,"discount="&discount, "buyer_alias="&buyer_alias, "cash_ticket_fee=" & cash_ticket_fee, "agentid=" & agentid)
